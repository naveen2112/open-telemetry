...
class TimelineCreateTest(BaseTestCase):
    ...
    def test_success(self):
        ...
        # Valid sceanrio 3: Valid inputs for all fields and is_active=False,
...
class TimelineDeleteTest(BaseTestCase):
    ...
    def test_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assert_database_not_has("Timeline", {"id": timeline.id})
...
class TimelineDatatableTest(BaseTestCase):
    ...
    def test_datatable(self):
        """
        To check whether all columns are present in datatable and
